...
class AnimalsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create animal" do
    assert_difference('Animal.count') do
      post animals_url, params: { animal: { idade: @animal.idade, nome: @animal.nome, raca: @animal.raca } }
    end
  ...
  test "should update animal" do
    patch animal_url(@animal), params: { animal: { idade: @animal.idade, nome: @animal.nome, raca: @animal.raca } }
